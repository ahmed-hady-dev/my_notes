...
void main() {
  group('Mock Authentication', () {
    ...
    test('create user should delegate to login function', () async {
      ...
      final badPassUser = provider.createUser(email: 'any@email.com', password: 'foobar');
      expect(badPassUser, throwsA(const TypeMatcher<WrongPasswordAuthException>()));

      final user = await provider.createUser(email: 'good@email.com', password: "goodPassword");
